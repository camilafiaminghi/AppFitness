...
export default class Live extends Component {
	...
	componentDidMount () {
		Permissions.getAsync(Permissions.LOCATION)
			...
			.catch((error) => {
				console.warn('Error get location permission', error)
		...
		if (status === 'denied') {
			return (
				<View style={styles.center}>
					...
					<Text>
						You denied your location. You can fix this by visiting your settings and enable location services for this app.
					</Text>
					<TouchableOpacity onPress={this.askPermission} style={styles.btn}>
